function varargout = Door_Selection(varargin)
% DOOR_SELECTION MATLAB code for Door_Selection.fig
%      DOOR_SELECTION, by itself, creates a new DOOR_SELECTION or raises the existing
%      singleton*.
%
%      H = DOOR_SELECTION returns the handle to a new DOOR_SELECTION or the handle to
%      the existing singleton*.
%
%      DOOR_SELECTION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DOOR_SELECTION.M with the given input arguments.
%
%      DOOR_SELECTION('Property','Value',...) creates a new DOOR_SELECTION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Door_Selection_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Door_Selection_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Door_Selection

% Last Modified by GUIDE v2.5 01-Nov-2018 08:12:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Door_Selection_OpeningFcn, ...
                   'gui_OutputFcn',  @Door_Selection_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Door_Selection is made visible.
function Door_Selection_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Door_Selection (see VARARGIN)

% Choose default command line output for Door_Selection
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Door_Selection wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Door_Selection_OutputFcn(hObject, eventdata, handles) 
