function varargout = Window_Selection2(varargin)
% WINDOW_SELECTION2 MATLAB code for Window_Selection2.fig
%      WINDOW_SELECTION2, by itself, creates a new WINDOW_SELECTION2 or raises the existing
%      singleton*.
%
%      H = WINDOW_SELECTION2 returns the handle to a new WINDOW_SELECTION2 or the handle to
%      the existing singleton*.
%
%      WINDOW_SELECTION2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WINDOW_SELECTION2.M with the given input arguments.
%
%      WINDOW_SELECTION2('Property','Value',...) creates a new WINDOW_SELECTION2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Window_Selection2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Window_Selection2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Window_Selection2

% Last Modified by GUIDE v2.5 01-Nov-2018 08:28:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Window_Selection2_OpeningFcn, ...
                   'gui_OutputFcn',  @Window_Selection2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Window_Selection2 is made visible.
function Window_Selection2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Window_Selection2 (see VARARGIN)

% Choose default command line output for Window_Selection2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Window_Selection2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Window_Selection2_OutputFcn(hObject, eventdata, handles) 
...
set(handles.area_glasswindow2_edit,'String','0');
...
% 
% Unorthwoodwindow = str2double(get(handles.edit22,'String'));
% CLTDnorthwoodwindow = str2double(get(handles.edit23,'String'));
% Usouthwoodwindow = str2double(get(handles.edit22,'String'));
% CLTDsouthwoodwindow = str2double(get(handles.edit23,'String'));
% Uwestwoodwindow = 0;
% CLTDwestwoodwindow = 0;
% Ueastwoodwindow = 0;
% CLTDeastwoodwindow = 0;
