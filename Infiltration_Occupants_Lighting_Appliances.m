function varargout = Infiltration_Occupants_Lighting_Appliances(varargin)
% INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES MATLAB code for Infiltration_Occupants_Lighting_Appliances.fig
%      INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES, by itself, creates a new INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES or raises the existing
%      singleton*.
%
%      H = INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES returns the handle to a new INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES or the handle to
%      the existing singleton*.
%
%      INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES.M with the given input arguments.
%
%      INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES('Property','Value',...) creates a new INFILTRATION_OCCUPANTS_LIGHTING_APPLIANCES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Infiltration_Occupants_Lighting_Appliances_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Infiltration_Occupants_Lighting_Appliances_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Infiltration_Occupants_Lighting_Appliances

% Last Modified by GUIDE v2.5 25-Oct-2018 12:36:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Infiltration_Occupants_Lighting_Appliances_OpeningFcn, ...
                   'gui_OutputFcn',  @Infiltration_Occupants_Lighting_Appliances_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Infiltration_Occupants_Lighting_Appliances is made visible.
function Infiltration_Occupants_Lighting_Appliances_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Infiltration_Occupants_Lighting_Appliances (see VARARGIN)

% Choose default command line output for Infiltration_Occupants_Lighting_Appliances
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Infiltration_Occupants_Lighting_Appliances wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Infiltration_Occupants_Lighting_Appliances_OutputFcn(hObject, eventdata, handles) 
...
Qappliances = Qlaptop + Qceilingfan + Qpasystem;
